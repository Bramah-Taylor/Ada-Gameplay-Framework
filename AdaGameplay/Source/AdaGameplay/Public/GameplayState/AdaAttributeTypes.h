...
DECLARE_MULTICAST_DELEGATE_FourParams(FAdaOnThresholdValueHit, const FGameplayTag /*AttributeTag*/, const float /*ThresholdValue*/, const float /*CurrentValue*/, const EAdaAttributeDelta /*Delta*/);
